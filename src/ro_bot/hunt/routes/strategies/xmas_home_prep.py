"""xmas ``home_prep`` — Kafra storage, healer (no field warp)."""
...
_KAFRA = Kafra((146, 136))
_HEALER = Healer((143, 138))


def home_prep_xmas() -> HomePrepConfig:
    """xmas save → Kafra deposit/withdraw → healer (walk to farm via home route)."""
